...
if($_SERVER["REQUEST_METHOD"]=="POST"){
	...
	curl_setopt_array($curl, array(
	  CURLOPT_URL => 'http://localhost/panaderia/index.php/registros',
	  ...
	  CURLOPT_POSTFIELDS =>'nombres='.$_POST['nombres'].'&apellidos='.$_POST['apellidos'].'&email='.$_POST['email'],
		...
		<?php if($_SERVER["REQUEST_METHOD"]=="POST"){ ?>
			<div class="row col-xl-12 my-6">
				...
				<div class="row col-xl-8 offset-2 bg-success text-white font-weight-bold py-2">
					<?php print_r("Cliente ID: ".$datos['credenciales']['cliente_id']); ?>
				</div>
